...
<Figure
  src="/work/withintech-learn/courses-light-theme.png"
  alt="The admin Courses list in light theme, showing Draft, Published, and Archived tabs and six published course cards with title, description, and creation date"
  width={1914}
  height={841}
  caption="The Courses admin view — light theme"
/>

<Figure
  src="/work/withintech-learn/courses-dark-theme.png"
  alt="The same admin Courses list rendered in dark theme, with the same six published course cards and tab counts"
  width={1884}
  height={892}
  caption="The same view in dark theme — the theme I built for the platform"
/>
